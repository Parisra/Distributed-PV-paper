...
\begin{document}
	...
	\begin{figure}
		\includegraphics[width=0.95\textwidth,]{./figure 3}
	...
	\begin{figure}
		\includegraphics[width=0.8\textwidth,center]{./figure 8}
	...
	The model is implemented by the open energy modeling framework PyPSA and makes use of the the model PyPSA-Eur-Sec v0.6.0 \cite{pypsa_docs} and the costs and technology assumptions included in the technology-data v0.4.0 \cite{pypsa_costs}. Dataset and scripts to reproduce the figures included in this paper are  publicly available at: \href{https://github.com/Parisra/Distributed-PV-paper}{/github.scripts}.
